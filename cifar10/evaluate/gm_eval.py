...
def metrics_print(net, expert_fn, n_classes, loader, T, save_metrics_csv=None):
    ...
    if overall_metrics["real_total"] > 0:
        ...
        #     "system accuracy": overall_system_acc.to("cpu"),
        #     "expert accuracy": overall_expert_acc.to("cpu"),
        #     "classifier accuracy": overall_classifier_acc.to("cpu"),
        #     "alone classifier": overall_alone_classifier_acc.to("cpu")
        # }
        # if save_metrics_csv is not None:
        #     save_metrics.append({
        #         "time_step": "overall",
...
save_root = f"models/general_curve_v2/20250924_094916"
result_root = f"results/general_curve_v2_test/{timestamp}"
