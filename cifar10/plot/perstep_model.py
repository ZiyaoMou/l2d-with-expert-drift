...
df = pd.read_csv('/home/zmou1/scratchenalisn1/ziyao/l2d-cog/cifar10H/results/mixed_perstep_eval_per_window.csv')
...
plt.ylabel("Accuracy")
plt.title("perstep L2D Model Accuracy on CIFAR-10H Over Trial Index")
plt.legend(loc='lower right', fontsize=8)
plt.ylim(0.5, 1.0)
plt.tight_layout()
plt.savefig("figures/mixed_curves/perstep_model_accuracy_over_trial_index.png", dpi=200)
# plt.show()  # 无显示环境可注释掉
...
plt.xlabel("Trial Index")
plt.ylabel("Accuracy")
plt.title("Perstep L2D Model Accuracy on CIFAR-10H Over Trial Index (Smoothed)")
plt.ylim(0.5, 1.0)
plt.grid(True, alpha=0.25, linestyle="--")
plt.legend(loc="lower right", fontsize=9)
plt.tight_layout()
plt.savefig("figures/mixed_curves/perstep_model_accuracy_over_trial_index_smooth.png", dpi=200)
# plt.show()
...
plt.title("Perstep L2D Model Defer Rate on CIFAR-10H Over Trial Index")
plt.ylim(0.0, 1.0)
plt.grid(True, alpha=0.25, linestyle="--")
plt.legend(loc="lower right", fontsize=9)
plt.tight_layout()
plt.savefig("figures/mixed_curves/perstep_model_defer_rate_over_trial_index_smooth.png", dpi=200)
