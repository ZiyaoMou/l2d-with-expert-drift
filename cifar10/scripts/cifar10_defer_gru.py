...
def make_augmented_sequence_datasets(
    ...
    """
    Returns: (train_dataset_indexed, test_dataset_indexed)
    Both can be directly fed to DataLoader; your IndexedCIFAR10 will calculate (seq_id, t) based on the passed indices.
    """
...
save_root = f"models/gru_curve_ft/{timestamp}"
result_root = f"results/gru_curve_ft/{timestamp}"
